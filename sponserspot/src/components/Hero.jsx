    ...
    return (
        <div className="w-full h-full flex items-center justify-center " >
            ...
            <div className="flex gap-3 mt-2 ">
                <button className="text-white bg-purple-700 px-4 py-2 rounded"  ><a href="/sponser/register"> Sign in as a sponser</a></button>
                <button className=" border-[1px] border-purple-400 text-purple-400 px-4 py-2 rounded" ><a href="/organizer/register">Sign in as event organizer</a></button>
            </div>
            </div>
        </div>
    ) 
