...
export const EventDetail = ()=>{
    ...
    const {getEventWithId} = useContext(EventContext);
    ...
    return (
        <div className="bg-zinc-950 min-h-screen w-full">
            ...
            <div className="h-[500px] w-full px-11 flex items-center gap-10">
                    ...
                    <img className="h-[400px] w-[600px] object-contain rounded-lg" src="https://media.istockphoto.com/id/1037898710/vector/abstract-vector-dynamic-background-futuristic-poster-for-corporate-meeting-online-courses.jpg?s=612x612&w=0&k=20&c=mLvsRyYsYqsErlmgvICCtEJp8npQCc_Qz7Jk7psoMEw=" alt="eventImage" />
                    <div className="h-[450px] w-1 bg-zinc-800"></div>
                    <div className="mt-15">
                        <h1 className="text-pink-400 text-3xl font-semibold">Smart India Hackathon</h1>
                        <p className="mr-16 text-zinc-500 mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem consequatur animi, placeat in libero unde quasi maiores veniam repellendus fugiat alias, dolor commodi necessitatibus hic iste nulla laboriosam vel iusto. Atque laborum possimus, laudantium itaque recusandae consectetur doloribus voluptate placeat.</p>
                    ...
                    <p className="text-zinc-400 font-semibold" >15 jan 2021 - 17 jan 2025</p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                    ...
                    <p className="text-zinc-400 font-semibold" >1k+ Expected Audience</p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
                    ...
                    <p className="text-zinc-400 font-semibold" >9878827854</p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.75V12A2.25 2.25 0 0 1 4.5 9.75h15A2.25 2.25 0 0 1 21.75 12v.75m-8.69-6.44-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
                        ...
                        <div className="flex flex-col mt-4">
                            <textarea className="bg-zinc-800 border-[1px] border-zinc-600 bg-opacity-30 rounded-lg px-2 py-2 placeholder:text-sm " id="" cols="10" rows="2" placeholder={message} ></textarea>
                            <div className="w-full h-10 bg-white mt-3 rounded-lg flex justify-center items-center">
